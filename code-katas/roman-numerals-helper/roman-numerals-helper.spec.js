describe("Roman Numerals Helper", () => {
    ...
    it("Joshua", () => {
        ...
        expect(RomanNumeralsJoshua.toRoman(69420)).toBe("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMCDXX");
        expect(RomanNumeralsJoshua.toRoman(99999)).toBe("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMCMXCIX");
        ...
        expect(RomanNumeralsJoshua.fromRoman("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMCMXCIX")).toBe(99999);
        expect(RomanNumeralsJoshua.fromRoman("MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMCDXX")).toBe(69420);
